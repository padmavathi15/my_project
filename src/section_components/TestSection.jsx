...
const TestSection = () => {
  ...
  const classOptions = ['Class 1', 'Class 2', 'Class 3'];  // You can adjust these values based on your needs
  const sectionOptions = ['A', 'B', 'C'];  // Adjust sections as needed
